...
set_target_properties(PhysFS::PhysFS-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/physfs-static.lib"
  )
...
# Import target "PhysFS::test_physfs" for configuration "Release"
set_property(TARGET PhysFS::test_physfs APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(PhysFS::test_physfs PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/test_physfs.exe"
  )
